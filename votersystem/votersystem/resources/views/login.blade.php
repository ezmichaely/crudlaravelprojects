            ...
            <div class="container">
                <div class="row gx-lg-5 align-items-center">
                    <div class="col-lg-6 mb-3 mb-lg-0 text-center">
                        <h1 class="my-4 display-3 fw-bold ls-tight text-primary font-title">
                            VOTERS SYSTEM
                        </h1>
                        <hr class="bg-dark">
                        ...
                        <div class="card">
                            <div class="card-body py-2 px-md-5">
                                <form method="post" action="{{ route('loginaccount') }}">
                                    ...
                                    <h5 class="my-4 text-center fw-bold ls-tight text-primary font-title">
                                        LOGIN ACCOUNT
                                    </h5>
                                    ...
                                    <div class="text-center mt-2">
                                        ...
                                        <a href={{ route('register') }} class="font-title fw-bold text-uppercase btn btn-outline-primary btn-floating mx-1 mb-4">
