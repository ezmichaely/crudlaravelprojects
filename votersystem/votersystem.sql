...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=218377870ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="255">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=votersystem&table=accounts">`votersystem`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=votersystem&table=voters">`votersystem`.`voters`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=products&table=products">`products`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=products&table=accounts">`products`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=products&table=users">`products`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=voters&table=voters">`voters`.`voters`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=voters&table=accounts">`voters`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=voters&table=users">`voters`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shoppe&table=products">`shoppe`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shoppe&table=users">`shoppe`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="623d33253c437e347250662544366f77">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="255"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="votersystem" targettable="voters">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `voters`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="votersystem" targettable="voters">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `voters`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="votersystem" targettable="accounts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
