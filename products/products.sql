...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=458878467ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=products&table=products">`products`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=products&table=accounts">`products`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=products&table=users">`products`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=voters&table=voters">`voters`.`voters`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=voters&table=accounts">`voters`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=voters&table=users">`voters`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shoppe&table=products">`shoppe`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shoppe&table=users">`shoppe`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_db&table=products">`laravel_db`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_db&table=accounts">`laravel_db`.`accounts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5b5228612263634b694174337d7b5525">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="shoppe" targettable="products">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="voters" targettable="voters">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `voters`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="voters" targettable="accounts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `voters`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="voters" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `voters`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="products" targettable="accounts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `accounts`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="products" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
