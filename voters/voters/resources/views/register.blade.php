...
<body>
    ...
    <main class="container">
        <h2 class="fw-bold text-uppercase text-center text-warning mt-5">VOTER'S REGISTRATION</h2>
                ...
                <div class="col-sm-12 col-lg-10">
                    <div class="row m-0 p-0">
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="py-3 px-4">
                                    <h3 class="fw-bold text-center bg-warning rounded py-2 my-3 shadow">USER REGISTRATION FORM</h3>
                                    ...
                                    <div class="mt-4">
                                        <form action="{{ route('newUser') }}" method="post">
                                            ...
                                            <div class="mt-3">
                                                <label for=""> <span class="fw-bold">FULLNAME<span class="text-danger">*</span></span> <span class="fst-italic">(Firstname, Middle Initial, Lastname) </span> </label>
                                                <div class="row gx-1 gy-1 m-0">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="d-flex flex-column">
                                                        <input type="text" class="form-control border border-primary" placeholder="MI" id="middleinitial" name="middleinitial"
                                            ...
                                            <div class="mt-2">
                                                <div class="row g-1 m-0">
                                                    <div class="col-sm-6">
                                                        <div class="d-flex flex-column">
                                                            <label for="" class="text-uppercase fw-bold">EMAIL ADDRESS<span class="text-danger">*</span></label>
                                                            <input type="email" class="form-control border border-primary" placeholder="Email Address" id="email" name="email"
                                                                value="{{ old('email') }}">
                                                                @error('email')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
