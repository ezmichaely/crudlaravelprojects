...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3157363912ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=voters&table=voters">`voters`.`voters`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=voters&table=accounts">`voters`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=voters&table=users">`voters`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shoppe&table=products">`shoppe`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shoppe&table=users">`shoppe`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_db&table=products">`laravel_db`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_db&table=accounts">`laravel_db`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shoppe&table=accounts">`shoppe`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shoppe&table=migrations">`shoppe`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=inventory&table=accounts">`inventory`.`accounts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
